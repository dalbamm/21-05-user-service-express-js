          ...
          <Container component="main" maxWidth="xs">
            ...
            <div className={classes.paper}>
              ...
              <form className={classes.form} noValidate>
                ...
                {
                  flagUnique && !flagValid ?
                    <Container disableGutters >
                      <Button fullWidth variant="contained"
                        className={flagUnique || !flagWait ? classes.check : classes.disabledCheck}
                        onClick={handleSendValidateMail}
                        disabled={!flagUnique || flagValid}
                      >
                        {flagValid ? "인증번호 검증 완료" : flagUnique ? (flagWait ? "인증번호 재발송" : "인증번호 발송") : "인증번호 발송(중복 확인을 먼저 해주세요)"}
                      </Button>
                      <CssBaseline />
                    </Container>
                    : <span></span>
                ...
                {
                  flagWait ? <Container disableGutters >
                    <Divider />
                    <TextField
                      variant="outlined"
                      margin="normal"
                  ...
                  flagValid ?
                    <Container disableGutters >
                      ...
                      <TextField
                        ...
                        fullWidth
                        name="password"
                        label={flagUnique && flagValid ? "비밀번호" : "비밀번호(인증 후 입력 가능합니다.)"}
                        type="password"
                        id="password"
                      ...
                      <TextField
                        ...
                        fullWidth
                        name="passwordRepeat"
                        label={flagUnique && flagValid ? "비밀번호 확인" : "비밀번호 확인(인증 후 입력 가능합니다.)"}
                        type="password"
                        id="passwordRepeat"
                        autoComplete="current-password"
                        onKeyDown={handleEnter}
                      ...
                      <Button
                        ...
                        fullWidth
                        variant="contained"
                        className={flagValid ? classes.submit : classes.disabledCheck}
                        onClick={handleClick}
                        disabled={!flagValid}
                      >
                        회원가입
